...
// ← KEY CHANGE: export a getter function instead of instantiating immediately
module.exports = {
  getPool: () => DatabaseSingleton.getInstance().getPool()
};
  // require('dotenv').config({ path: require('path').resolve(__dirname, '../.env') });
  // const { Pool } = require('pg');
  // // added it above pool to fix issue require('dotenv').config();
